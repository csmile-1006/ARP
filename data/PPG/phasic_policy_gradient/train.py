...
def train_fn(
    ...
    if comm is None:
        comm = MPI.COMM_WORLD
    tu.setup_dist(comm=comm, start_port=start_port)
    ...
    ppg.learn(
        ...
        ppo_hps=dict(
            ...
            log_save_opts={"save_mode": "periodic", "save_period": 10},
        ),
        aux_lr=aux_lr,
...
def main():
    ...
    # CY: Optionize procgen environments.
    parser.add_argument("--log_dir", type=str, default="./logs/ppg")
    parser.add_argument("--start_level", type=int, default=0)
    parser.add_argument("--num_levels", type=int, default=200)
    parser.add_argument("--distribution_mode", type=str, default="hard")
    parser.add_argument("--start_port", type=int, default=29500)
